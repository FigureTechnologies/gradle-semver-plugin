...
private fun buildPluginConfig(branchMatching: List<BranchMatchingConfiguration>): VersionCalculatorConfig {
...
private fun mockSemVerContext(ops: ContextProviderOperations): SemverContext {
