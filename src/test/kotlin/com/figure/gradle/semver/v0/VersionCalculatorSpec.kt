...
//                     branchVersions,
//                     config
//                 ).shouldBeRight() shouldBe mainBranchVersion.nextPatch()
//
//                 // current != main
//                 setOf(
...
//                     branchVersions,
//                     config
//                 ).shouldBeRight() shouldBe mainBranchVersion.nextPatch().copy(preRelease = "beta.2")
//                 calculateBranchVersion(
//                     GitRef.Branch("hotfix/something"),
//                     branchVersions,
//                     config
//                 ).shouldBeRight() shouldBe mainBranchVersion.nextPatch().copy(preRelease = "rc.2")
//
...
//                             """^develop$""".toRegex(),
//                             GitRef.Branch.Main,
//                             { preReleaseWithCommitCount(it, GitRef.Branch.Main, "beta") to "" },
//                             versionModifier
//                         ),
//                         BranchMatchingConfiguration(
//                             """^feature/.*""".toRegex(),
...
//                             """^hotfix/.*""".toRegex(),
//                             GitRef.Branch.Main,
//                             { preReleaseWithCommitCount(it, GitRef.Branch.Main, "rc") to "" },
//                             versionModifier
//                         ),
//                     )
//                 )
...
//
//                 calculateBranchVersion(
//                     GitRef.Branch("sroman/sc-145300/standardized-gradle-build"),
//                     branchVersions,
//                     config
//                 )
//                     .shouldBeRight()
//                     .shouldBe(
//                         mainBranchVersion.nextPatch().nextPatch()
//                             .copy(preRelease = "sc-145300-standardized-gradle-build.2")
//                     )
//
//                 calculateBranchVersion(
//                     GitRef.Branch("sroman/no-ticket/standardized-gradle-build"),
//                     branchVersions,
//                     config
//                 )
//                     .shouldBeRight()
